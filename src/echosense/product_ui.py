...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    button,.button-link { border:1px solid #343d4f; border-radius:12px; padding:12px 16px; font:inherit; font-weight:680; cursor:pointer; text-decoration:none; display:inline-block; }
